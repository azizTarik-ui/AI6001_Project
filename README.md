...
Download or clone the project files to your computer. Once extracted your folder should look like this:
...
**Step 1** — Open Docker Desktop and wait until it says "Docker is running" in the bottom left corner.

**Step 2** — Open a terminal inside the `chess-realm` folder.
- On Windows, navigate to the folder in File Explorer, click the address bar, type `cmd` and press Enter.
- On Mac, open Terminal and drag the folder into it.
...
No rebuild needed unless you changed the code.
